...
class chart_bittrex {
    ...
    init(dateSt:String, dateSt_now:String, periods:String) {
        if (!chart_bittrex.is_doing_c && !chart_bittrex.is_doing_p){
            //chart_bittrex.is_doing_c = true
            //chart_bittrex.is_doing_p = true
            var url2:URL
            let url3:URL
            ...
            let task2 = URLSession.shared.dataTask(with: url2 as URL) { data, response, error in
                ...
                tmppp = text
                chart_bittrex.is_doing_c = false
            }
            ...
            let task = URLSession.shared.dataTask(with: url! as URL) { data, response, error in
                ...
                usbtc = Float(text.components(separatedBy: "\"USDT-BTC\"")[1].components(separatedBy: "\"Last\":")[1].components(separatedBy: ",")[0])!
                task2.resume()
                
                if (to_find == "BTC"){
                    let usdt_btc_str = text.components(separatedBy: "\"USDT-BTC")[1]
                    
                    dataa[0] = String(Int(Float(table_controller.usd)! * usbtc))
                    dataa[2] = usdt_btc_str.components(separatedBy: "\"PrevDay\":")[1].components(separatedBy: ",")[0]
                    dataa[2] = String(Int(Float(table_controller.usd)! * Float(dataa[2])!))
                    dataa[3] = usdt_btc_str.components(separatedBy: "\"High\":")[1].components(separatedBy: ",")[0]
                    dataa[3] = String(Int(Float(table_controller.usd)! * Float(dataa[3])!))
                    dataa[4] = usdt_btc_str.components(separatedBy: "\"Low\":")[1].components(separatedBy: ",")[0]
                ...
                else if text.contains("\"BTC-" + to_find){
                    let usdt_btc_str = text.components(separatedBy: "\"BTC-" + to_find)[1]
                    
                    dataa[0] = usdt_btc_str.components(separatedBy: "\"Last\":")[1].components(separatedBy: ",")[0]
                    dataa[0] = String(Int(Float(table_controller.usd)! * Float(dataa[0])! * usbtc))
                    dataa[2] = usdt_btc_str.components(separatedBy: "\"PrevDay\":")[1].components(separatedBy: ",")[0]
                    dataa[2] = String(Int(Float(table_controller.usd)! * Float(dataa[2])! * usbtc))
                    dataa[3] = usdt_btc_str.components(separatedBy: "\"High\":")[1].components(separatedBy: ",")[0]
                ...
                chart_bittrex.is_doing_p = false
            }
            task.resume()
        }
    }
