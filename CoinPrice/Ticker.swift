            ...
            let task = URLSession.shared.dataTask(with: url! as URL) { data, response, error in
                ...
                for i in 0...coin_kind.count - 1 {
                    if coin_kind[i][1] == "Bithumb" && text.contains(coin_kind[i][0]){
                        ...
                        coin_kind[i][5] = ( "KRW")
                        coin_kind[i][6] = self.split(str: main_coin_str,w1: "\"volume_1day\":\"",w2: "\"")
            ...
            let task = URLSession.shared.dataTask(with: url! as URL) { data, response, error in
                ...
                for i in 0...coin_kind.count - 1 {
                    if coin_kind[i][1] == "Coinone" && text.contains("\"" + coin_kind[i][0].lowercased() + "\""){
                        ...
                        coin_kind[i][5] = ("KRW")
                        coin_kind[i][6] = self.split(str: main_coin_str,w1: "\"volume\":\"",w2: "\"")
                ...
                for i in 0...coin_kind.count - 1 {
                    if (coin_kind[i][1] == "Poloniex"){
                        if text.contains("\"USDT_" + coin_kind[i][0] + "\""){
                            ...
                            coin_kind[i][5] = ("USDT")
                            coin_kind[i][6] = self.split(str: whole_str,w1: "\"quoteVolume\":\"",w2: "\"")
                        }
                            ...
                            coin_kind[i][5] = ("BTC")
                            coin_kind[i][6] = self.split(str: main_coin_str,w1: "\"quoteVolume\":\"",w2: "\"")
                        }else{
                            coin_kind[i][2] = "미지원"
                            coin_kind[i][3] = "미지원"
                        }
                ...
                if ( coin_kind[i][1] == "Korbit"){
                    ...
                    let task = URLSession.shared.dataTask(with: url! as URL) { data, response, error in
                        ...
                        if (text.contains("\"last\":\"")){
                            ...
                            coin_kind[i][5] = ("KRW")
                            coin_kind[i][6] = self.split(str: text,w1: "\"volume\":\"",w2: "\"")
                ...
                if ( coin_kind[i][1] == "Coinnest"){
                    ...
                    let task = URLSession.shared.dataTask(with: url! as URL) { data, response, error in
                        ...
                        if (text.contains("\"last\":")){
                            ...
                            coin_kind[i][3] = "미지원"
                            coin_kind[i][5] = ("KRW")
                            coin_kind[i][6] = self.split(str: text,w1: "\"vol\":",w2: ",")
                    ...
                    for i in 0...coin_kind.count - 1 {
                        ...
                        if ( coin_kind[i][1] == "Upbit"){
                            if (text.contains("CRIX.UPBIT.KRW-" + coin_tmp)){
                                ...
                                coin_kind[i][5] = ("KRW")
                                coin_kind[i][6] = self.split(str: lets_text,w1: "\"accTradeVolume24h\":",w2: ".")
                        ...
                        for i in 0...coin_kind.count - 1 {
                            ...
                            if ( coin_kind[i][1] == "Yobit"){
                                if (text.contains("\"" + coin_tmp + "_usd\"")){
                                    ...
                                    coin_kind[i][5] = ("USD")
                                    coin_kind[i][6] = self.split(str: lets_text,w1: "\"vol\":",w2: ".")
                                }else if (text.contains("\"" + coin_tmp + "_btc\"")){
                                    let lets_text = text.components(separatedBy: "\"" + coin_tmp + "_btc\"")[1]
                                    coin_kind[i][2] = self.split(str: lets_text,w1: "\"last\":",w2: ",")
                                    coin_kind[i][2] = String(Int(Float(coin_kind[i][2])! * Float(table_controller.usd)! * btc_usd))//달러 적용 현재가
                                    coin_kind[i][3] = "미지원"
                            ...
                            if primium_change == "Yobit"{
                                if !(primium.contains {$0.contains(coin_tmp)}){
                                    if (text.contains("\"" + coin_tmp + "_usd\"")){
                                        ...
                                        let lets_text = text.components(separatedBy: "\"" + coin_tmp + "_btc\"")[1]
                                        var tmppp = self.split(str: lets_text,w1: "\"last\":",w2: ",")
                                        tmppp = String(Int(Float(tmppp)! * Float(table_controller.usd)! * btc_usd))//달러 적용 현재가
                                        primium.append([coin_kind[i][0].uppercased(),tmppp])
                                    }
                                }
                            }
